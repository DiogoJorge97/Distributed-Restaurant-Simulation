...
public class ClientProxy extends Thread {
     ...
     */
    private GeneralRepoInterface generalRepoInterface;

    /**
     * Creation of interface instance
     *
     * @param sconi Communication channel
     * @param generalRepoInterface GeneralRepo Interface
     */
    public ClientProxy(ServerCom sconi, GeneralRepoInterface generalRepoInterface) {
        super("Proxy_" + ClientProxy.getProxyId());

        this.sconi = sconi;
        this.generalRepoInterface = generalRepoInterface;
    }
    ...
    public void run() {
        ...
        try {
            outMessage = generalRepoInterface.processAndReply(inMessage);         // processá-lo
